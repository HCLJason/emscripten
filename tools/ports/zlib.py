...
VERSION = '1.2.13'
HASH = '99f0e843f52290e6950cc328820c0f322a4d934a504f66c7caa76bd0cc17ece4bf0546424fc95135de85a2656fed5115abb835fd8d8a390d60ffaf946c8887ad'

def needed(settings):
  return settings.USE_ZLIB

def get(ports, settings, shared):
  ports.fetch_project('zlib', 'https://github.com/madler/zlib/archive/refs/tags/v' + VERSION + '.zip', 'zlib-' + VERSION, sha512hash=HASH)
  def create(final):
